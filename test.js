...
tape("Does not calculate sales taxes and total price for unavailable products", (t) => {
  ...
  t.equal(receipt.unavailableProducts["001"], 'The selected product "football" is not in our product range', "test if the unavailable product information text is as expected")
